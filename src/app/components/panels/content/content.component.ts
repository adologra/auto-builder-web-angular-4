...
@Component({
  ...
  inputs : ['sectionConfiguration', 'markdownDocumentList'],
  entryComponents: [
                LeftMenuComponent,
...
export class ContentComponent {
    ...
    onSelectMarkdown (idSelected: string) {
        this.markdownId = idSelected;
        this.tableContentList = [];
    }

    private addMenuItems(escapedText: String, text: String, level: Number) {
        let title: ItemMenu = new ItemMenu();
    ...
    public getMarkDownDocumentPath(): String {
        let selectedMarkdown: MarkdownOptions;
